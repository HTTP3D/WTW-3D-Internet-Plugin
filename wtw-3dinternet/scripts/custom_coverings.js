WTW_3DINTERNET.prototype.addCoveringMyCustomCovering = function(zmoldname, zmolddef, zlenx, zleny, zlenz, zspecial1, zspecial2) {
	let zcovering;
	try {
		...
		WTW.log("plugins:wtw-3dinternet:scripts-custom_coverings.js-addCoveringMyCustomCovering=" + ex.message);
	}
	return zcovering;
}

WTW_3DINTERNET.prototype.setCoveringFormFields = function(zcoveringname) {
	try {
		...
		WTW.log("plugins:wtw-3dinternet:scripts-custom_molds.js-setCoveringFormFields=" + ex.message);
	}
}
