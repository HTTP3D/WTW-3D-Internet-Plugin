WTW_3DINTERNET.prototype.addActionZoneMyCustomZone = function(actionzonename, actionzoneind, actionzonedef) {
	let actionzone;
	try {
		...
		WTW.log("plugins:wtw-3dinternet:scripts-custom_actionzones.js-addActionZoneMyCustomZone=" + ex.message);
	}
	return actionzone;
}

WTW_3DINTERNET.prototype.setNewActionZoneDefaults = function(zactionzonetype) {
	try {
		...
		WTW.log("plugins:wtw-3dinternet:scripts-custom_actionzones.js-setNewActionZoneDefaults=" + ex.message);
	}
}
		
WTW_3DINTERNET.prototype.setActionZoneFormFields = function(zactionzonetype) {
	try {
		/* add each custom action zone to this one function as a case - no need to add additional hooks */
		...
		WTW.log("plugins:wtw-3dinternet:scripts-custom_actionzones.js-setActionZoneFormFields=" + ex.message);
	}
}
